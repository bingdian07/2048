...
KeyboardInputManager.prototype.listen = function () {
    ...
    this.bindButtonPress(".keep-playing-button", this.keepPalying);
    ...
    gameContainer.addEventListener(this.eventTouchend, function (event)  {
        ...
        var dx = touchEndClientX - touchEndClientX;
        var absDx = Math.abs(dx);

        var dy = touchEndClientY - touchEndClientY;
...
KeyboardInputManager.prototype.keepPalying = function (event) {
    event.preventDefault();
